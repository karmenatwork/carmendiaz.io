...
// Icons
import { ChevronDownIcon, CloseIcon, HomeModernIcon, CIcon, MountainIcon, BurguerMenuIcon } from "@/components/CustomIcons";
...
function MobileNavigation(
  ...
  return (
    <Popover {...props}>
      <PopoverButton className="group flex items-center rounded-lg bg-white/90 px-4 py-2 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 dark:hover:ring-white/20">
        {/* Menu */}
        <BurguerMenuIcon className="size-6 h-6 w-6 text-zinc-500 dark:text-zinc-400" />
      ...
      <Transition>
        ...
        >
          <PopoverPanel
            focus
            className="fixed inset-x-4 top-8 z-50 origin-top rounded-lg bg-white p-8 ring-1 ring-zinc-900/5 dark:bg-zinc-900 dark:ring-zinc-800"
          >
