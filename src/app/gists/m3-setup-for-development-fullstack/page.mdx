...
- <Link href="/gists/macos-setup-software-development" target="_blank">MacOS setup for software development</Link>

- <Link href="/gists/m3-setup-for-development-env-basics" target="_blank">MacOS setup for development basics</Link>
...
Check 
<Link href="/gists/m3-setup-for-development-env-python" target="_blank">MacOS setup for Python </Link> for `pyenv`
