...
export const gist = {
  ...
  description:
    'My old Macbook pro laptop\'s sound died right as I began my ML/AI bootcamp, reparing it would take a couple of weeks, so I took a leap and invested in an M3 MacBook. It\'s a game-changer, but setting it up for development is quiet an adventure. Here are',
}
...
As I was setting it up, I took some notes (in case I need to re-do it :)
...
Apple provides its own built-in Mac Terminal application, but most developers prefers alteranatives such as [iterm2](https://iterm2.com/#/section/home), [warp](https://www.warp.dev/), [hyper](https://hyper.is/). I have personally been using iterm2 for years. Download it [here](https://iterm2.com/downloads.html)
...
As a developer you will need a package manager, and Homebrew is one of the favorites/recommended one.
...
I use [ohmyz] (https://ohmyz.sh/#install), and open source, community-driven framework for managing Zsh configuration. To install run and follow its instructions.
